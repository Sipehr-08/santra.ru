...
export default Vue.extend({
  head() {
    return {
      ...
      meta: [
        { hid: 'description', name: 'description', content: 'Накидки на автомобильные сиденья от  ⭐ Cantra™ в Москве  , большой выбор люксовых накидок - ✓ Передние накидки ✓ Комплекты накидок ✓ Задние накидки ✓ Аксессуары,  Заказы ☎ +7 499 967-84-41'},
