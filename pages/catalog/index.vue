...
export default {
  ...
  head() {
    return {
      title: 'Накидки на сиденья автомобиля /  накидки на сиденья купить - Cantra.ru™',
      meta: [
        { hid: 'description', name: 'description', content: 'Каталог накидок на сиденья в Магазине Cantra  в Москве ⭐  У нас представлен большой выбор накидок на сиденья из различного материала. Доставка по России ☎ +7 499 967-84-41\n'},
